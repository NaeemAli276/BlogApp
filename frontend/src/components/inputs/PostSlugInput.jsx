...
const PostSlugInput = ({ slug , onChange }) => {
        ...
        >
            ...
            >
                <TextInput
                    ...
                    showName={true}
                    secondaryText={'Type in an appropriate slug, so users can find your posts more easily. If nothing is entered, it will automatically create one for you when posted.'}
                ...
                <button
                    ...
                    onClick={() => hyphenateAndLowercase(currentSlug)}
                >
