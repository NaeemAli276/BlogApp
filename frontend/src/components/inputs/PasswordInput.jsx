...
const PasswordInput = ({ value, name, onChange, secondaryText, secondaryTextShow, placeholderText,isRequired =false }) => {
    ...
    return (
        ...
        >
            ...
            />
            <button
                className='absolute top-6.5 right-2 p-2 text-primary dark:text-dark-primary'
