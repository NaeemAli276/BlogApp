...
const Toolbar = ({ allowedCommands }) => {

    const [currentAllowedCommands, setCurrentAllowedCommands] = useState(
        allowedCommands ||
        {
            listItem: true,
            codeBlock: true,
    ...
    const styleCommands = [
        {
            ...
            isAllowed: currentAllowedCommands.bold
        },
        {
            ...
            isAllowed: currentAllowedCommands.italic
        },
        {
            ...
            isAllowed: currentAllowedCommands.underline
        },
        {
            btnTitle: 'Blockquote',
            ...
            isAllowed: currentAllowedCommands.blockQuote
        },
    ...
    const headingCommands = [
        {
            ...
            isAllowed: currentAllowedCommands.headings
        },
        {
    ...
    const codeCommands = [
        {
            ...
            isAllowed: currentAllowedCommands.codeBlock
        },
    ]
    const miscCommands = [
        {
