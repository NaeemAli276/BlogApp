...
const PostTagBtn = ({ name, ftn = {} }) => {
    ...
    return (
        <button
            className='flex flex-row items-center gap-2 w-fit h-fit p-1 px-2.5 rounded-full bg-accent/20 dark:bg-dark-secondary cursor-pointer dark:text-dark-primary text-primary '
            onClick={() => handleClick()}
        >
            <h2
                className='text-sm'
