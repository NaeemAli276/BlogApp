...
import PostSlugInput from '../../inputs/PostSlugInput'
import TagBlock from '../../card/TagBlock'
import JsonViewer from '../../general/JsonViewer'
import CreateBlockBtn from '../../buttons/CreateBlockBtn'

const ContentManager = ({ postDetails, setPostDetails }) => {
