...
const DashboardTopbar = () => {
    ...
    return (
        <div
            className='row-span-1 col-span-16 flex flex-col gap-1 w-full h-full bg-background dark:bg-dark-background text-text dark:text-dark-text p-2 rounded-md shadow-text/50 shadow px-3 items-center'
        >   
            <div
